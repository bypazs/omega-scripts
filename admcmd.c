  /*
    Place in init.c -> C:\Program Files (x86)\Steam\steamapps\common\DayZServer\mpmissions\dayzOffline.chernarusplus\init.c
  */
	...
	ref TStringArray admins = {"xxxxxxxxxxxxxxx"}; // Add your BI UID or SteamID
